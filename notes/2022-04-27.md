...
- updates on `EntityMetadata` (https://hackmd.io/@radu/rkoq-cZ45)
...
- `EntityMetadata`
    ...
    - Radu: we need to distinguish between *named entities*,
      *entity releases*, and *entity contents*. We need to agree
    ...
    - Michelle: last week we talked about wanting to know who published
      ...
      contents of the actual entity. And so should those live in the module
